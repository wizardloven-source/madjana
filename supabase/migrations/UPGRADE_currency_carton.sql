-- ============================================================================
-- طھط±ظ‚ظٹط©: ط§ظ„ط¹ظ…ظ„ط© ط§ظ„ط¯ظٹظ†ط§ظ…ظٹظƒظٹط© (ط¯ظˆظ„ط§ط±/ظ„ظٹط±ط©) + ظ…ط®ط²ظˆظ† طµط­ظˆظ† ط§ظ„ظƒط±طھظˆظ†
--
...
--
-- 1) farms  : ط¹ظ…ظˆط¯ ط­ط¯ ط§ظ„طھظ†ط¨ظٹظ‡ ظ„ظ…ط®ط²ظˆظ† طµط­ظˆظ† ط§ظ„ظƒط±طھظˆظ† (طµط­ظ†)
-- 2) payments: ط¹ظ…ظˆط¯ط§ ط§ظ„ط¹ظ…ظ„ط© ظˆط³ط¹ط± ط§ظ„طµط±ظپ (طھط®ط²ظٹظ† ط¨ط§ظ„ط¯ظˆظ„ط§ط± ط¯ط§ط¦ظ…ط§ظ‹)
-- 3) expenses: ط¹ظ…ظˆط¯ط§ ط§ظ„ط¹ظ…ظ„ط© ظˆط³ط¹ط± ط§ظ„طµط±ظپ + ط¹ط¯ط¯ ط±ط¨ط·ط§طھ ط§ظ„ظƒط±طھظˆظ† ط§ظ„ظ…ط´طھط±ط§ط©
-- 4) ظپط¦ط© ظ…طµط±ظˆظپ ط¬ط¯ظٹط¯ط©: carton (طµط­ظˆظ† ظƒط±طھظˆظ†)
-- 5) ط¥ط¹ط§ط¯ط© ط¥ظ†ط´ط§ط، sync_records_batch ظ…ط¹ ط§ظ„ط³ظ…ط§ط­ ط¨ط§ظ„ط£ط¹ظ…ط¯ط© ط§ظ„ط¬ط¯ظٹط¯ط© ظپظٹ ط§ظ„ظ…ط²ط§ظ…ظ†ط©
-- ============================================================================

-- 1) ط­ط¯ ط§ظ„طھظ†ط¨ظٹظ‡ ظ„ظ…ط®ط²ظˆظ† طµط­ظˆظ† ط§ظ„ظƒط±طھظˆظ† ظپظٹ ط¬ط¯ظˆظ„ ط§ظ„ظ…ط¯ط§ط¬ظ†
ALTER TABLE farms
    ADD COLUMN IF NOT EXISTS carton_low_threshold INTEGER NOT NULL DEFAULT 100;

-- 2) ط§ظ„ظ‚ط¨ط¶: ط§ظ„ط¹ظ…ظ„ط© ظˆط³ط¹ط± ط§ظ„طµط±ظپ (ط§ظ„ظ…ط¨ط§ظ„ط؛ طھظڈط®ط²ظژظ‘ظ† ط¨ط§ظ„ط¯ظˆظ„ط§ط± ظˆظ‡ظˆ ط§ظ„ط£ط³ط§ط³ظٹ)
...
-- 3) ط§ظ„ظ…طµط±ظˆظپط§طھ: ط§ظ„ط¹ظ…ظ„ط© ظˆط³ط¹ط± ط§ظ„طµط±ظپ + ط¹ط¯ط¯ ط±ط¨ط·ط§طھ ط§ظ„ظƒط±طھظˆظ† ط§ظ„ظ…ط´طھط±ط§ط©
...
-- 4) ظپط¦ط© ظ…طµط±ظˆظپ ط¬ط¯ظٹط¯ط©: طµط­ظˆظ† ظƒط±طھظˆظ† (طھط´طھط±ظ‰ ط±ط¨ط·ط§طھطŒ ط§ظ„ط±ط¨ط·ط© = 100 طµط­ظ†)
ALTER TABLE expenses
...
-- 5) ط¥ط¹ط§ط¯ط© ط¥ظ†ط´ط§ط، sync_records_batch ظ…ط¹ ط§ظ„ط³ظ…ط§ط­ ط¨ط§ظ„ط£ط¹ظ…ط¯ط© ط§ظ„ط¬ط¯ظٹط¯ط©
